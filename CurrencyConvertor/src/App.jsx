...
function App() {
  ...
  //used to extract keys from Object
  const options = Object.keys(currencyInfo);

  // this function is used for currency swaping 
  const swap = () =>{
     setFrom(to)
     setTo(from)
  ...
  return (
      <div
       ...
       justify-center items-center bg-cover bg-no-repeat"
        style={{
          backgroundImage:`url('https://wallpaperaccess.com/full/799795.jpg')`,
        }}>
           ...
           backdrop-blur-sm bg-white/30">
            <form
               onSubmit={(e)=>{
                ...
                <div className="relative w-full h-05.">
                  <button
                   type="buttom"
                ...
                <div className="w-full mt-1 mb-4">
                  ...
                  text-white px-4 py-3 rounde-lg">
